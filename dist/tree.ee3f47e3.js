...
var addTree = function addTree(node, value) {
  var newNode = {
    date: value,
    children: null,
    parent: node
...
var removeNode = function removeNode(tree, node) {
  var siblings = node.parent.children; //这个节点的父亲的所有儿子，之前写成tree.node.children报错，因为这是找它的儿子了   
...
var node1 = addTree(tree, 20);
var node2 = addTree(tree, 30);
var node4 = addTree(tree, 40);
addTree(tree, 50);
addTree(node1, 201);
addTree(node1, 202);
addTree(node1, 203);
